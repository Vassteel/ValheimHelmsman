...
[BepInPlugin(Guid, "Valheim Helmsman", "0.2.33")]
...
public sealed class Plugin : BaseUnityPlugin
{
    ...
    private void Awake()
    {
        ...
        Logger.LogInfo("Helmsman 0.2.33 loaded. Peer-owned voyages and server-coordinated ship calls; no voyage resumes automatically on load.");
    }
