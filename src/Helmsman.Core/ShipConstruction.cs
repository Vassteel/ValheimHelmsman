...
public static class ShipConstruction
{
    ...
    public static readonly IReadOnlyList<ShipBlueprint> Blueprints = Array.AsReadOnly(new[] {
        ...
        new ShipBlueprint("little_boat", "Little boat", "LittleBoat", "LeatherScraps:8,Wood:40", 240),
        new ShipBlueprint("hercule", "Hercule fishing boat", "HerculeShip", "ClothShip:2,ResinWood:30,BronzeNails:100,ShipRope:2", 360),
        new ShipBlueprint("merchant", "Merchant's boat", "MercantShip", "ClothShip:4,ResinWood:40,IronNails:100,ShipRope:2", 480),
        ...
        new ShipBlueprint("warship", "War ship", "WarShip", "ClothShip:4,CaulkedWood:50,IronNails:120,ShipRope:2", 1080),
