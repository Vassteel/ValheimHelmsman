...
for side in [-1,1]:
 label='starboard' if side==-1 else 'port';yy=side*2.58
 for x in [-.30,.30]:
  tube('Boarding ladder / '+label+' side rope',[(x,side*2.06,2.06),(x,side*2.22,2.42),(x,side*2.48,2.49),(x,yy,2.26),(x,yy,-.37)],.030,rope,8)
 ...
 attachments.append({'id':'boarding_'+label,'kind':'boarding ladder','position':[0,side*2.63,.66],
...
report={'name':'Ottar','status':'Standalone visual study. Not imported, registered, packaged or installed in Helmsman.',
 ...
 'units':'metres; Blender X forward, Y port, Z up','nominal_hull_length':15.84,'nominal_beam':4.8,'revision':4,'cargo_barrels':14,'cargo_hide_bales':12,'cargo_sacks':18,'cargo_rolled_bundles':6,'cargo_timber_bundles':2,'grating_panels':0,'helm_benches':1,'passenger_seats':4,'mast_holdfasts':1,'boarding_ladders':2,
