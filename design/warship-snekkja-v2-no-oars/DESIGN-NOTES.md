# WarShip — snekkja study, revision 2
...
- Target archaeological proportions, low clinker hull, thirteen thwarts retained as passenger benches.
- Round oarports remain as hull detail; all rowing oars are removed at the user's request for Valheim.
...
The Blender scene and GLB include the full sail and steering oar, with no rowing oars. Deck and profile renders hide the sailcloth for inspection. Attachment positions are preliminary guides only. No Unity collisions, seated animations, steering, flotation or player movement have been implemented or tested.
