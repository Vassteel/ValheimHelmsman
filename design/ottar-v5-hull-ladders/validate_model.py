...
print('PASS: no grating; increased cargo counts; all cargo inside the rails; five backless seats and one mast grab bar; eight attachment guides and two hull-following nine-rung boarding ladders and end-deck gear; valid ship-only GLB.')
