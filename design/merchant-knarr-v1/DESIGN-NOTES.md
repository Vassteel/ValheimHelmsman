# Merchant knarr - standalone model study
...
- merchant-knarr.blend: editable parts, procedural grain, studio lights and full-sail camera.
- merchant-knarr.glb: ship only, with base material colours; no studio.
- merchant-knarr-hero.png: render of the actual model with full sail.
- merchant-knarr-deck.png: inspection render with sail cloth hidden to show the holds and working decks.
