...
R=Path(__file__).resolve().parents[2];OUT=R/'design/harbor-refinement-v3'
...
for item in models:
 ...
 cam.location=center+Vector((4,-6,4.2 if key not in ['keel-cradle','roller-bed'] else 6))*factor
