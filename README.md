# Valheim Helmsman — 0.2.0 prototype
...
- Karve, vanilla Longship (`VikingShip`), and registered modded ships using standard `Ship` physics and controls are detected. Ships with custom movement implementations need an adapter.
